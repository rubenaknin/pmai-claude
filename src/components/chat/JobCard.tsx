...
export function JobCard({
  ...
  return (
    <div
      ...
      } ${isHighlighted ? "animate-[highlight-pulse_1.5s_ease-in-out]" : ""}`}
    >
...
function JobCardRetryDropdown({ job, onApply, onSelfApply }: { job: Job; onApply: (jobId: string) => void; onSelfApply?: (jobId: string) => void }) {
